...
2. Let specification ϕ be a formula over the set Prop. \newline \newline
3. Check that M |H ϕ: \newline \newline
• Translate the specification ¬ϕ into a Büchi automaton A¬ϕ and compose it with the
system model M to form AM, ¬ϕ
. \newline \newline
• Check AM, ¬ϕ
for nonemptiness. That is, search for a trace that is accepted by AM, ¬ϕ \newline \newline
.
