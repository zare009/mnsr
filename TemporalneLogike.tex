	...
	\author {Djordje Todorovi\'{c}, Stefan Zari\'{c}, Maksim Djurdjevac\\ mi12090@matf.bg.ac.rs, drugog (trećeg) autora}
	\date{8.~april 2017.}
	\maketitle

	\abstract{
	Ovaj seminarski rad obradjuje temu temporalne logike, zapravo upotrebu logike u računarstvu.
	Preciznije su opisane osnove linarne temporalne logike (LTL) i logike stabla 
	izračunavanja (CTL), osnovne primene ovih logika, takodje i najpoznatiji alati za proveravanje modela,
